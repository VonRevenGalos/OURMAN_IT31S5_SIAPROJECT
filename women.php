...
// Add category filter (women's products only - womenathletics, womenrunning, womensneakers)
$whereConditions[] = "category IN ('womenathletics', 'womenrunning', 'womensneakers')";
...
try {
    ...
    $brands = [];
    $collections = [];
    $categories = ['womenathletics', 'womenrunning', 'womensneakers'];
    
    // Get filter options optimized - single query approach
    $filterStmt = $pdo->prepare("
        SELECT brand, collection, price
        FROM products
        WHERE category IN ('womenathletics', 'womenrunning', 'womensneakers')
    ");
    $filterStmt->execute();
...
<head>
    ...
    <title>Women's Shoes - ShoeARizz</title>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="page-header">
                        <h1 class="page-title">
                            <i class="fas fa-female me-3"></i>Women's Collection
                        </h1>
                        <p class="page-subtitle">Discover the latest collection of women's footwear</p>
                    </div>
                </div>
            </div>
                            ...
                            <div class="filter-group">
                                ...
                                <div class="filter-options">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="category[]" value="womensneakers" 
                                               id="category_womensneakers" <?php echo (in_array('womensneakers', $category)) ? 'checked' : ''; ?>>
                                        <label class="form-check-label" for="category_womensneakers">
                                            Women Sneakers
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="category[]" value="womenrunning" 
                                               id="category_womenrunning" <?php echo (in_array('womenrunning', $category)) ? 'checked' : ''; ?>>
                                        <label class="form-check-label" for="category_womenrunning">
                                            Women Running
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="category[]" value="womenathletics" 
                                               id="category_womenathletics" <?php echo (in_array('womenathletics', $category)) ? 'checked' : ''; ?>>
                                        <label class="form-check-label" for="category_womenathletics">
                                            Women Athletics
                                        </label>
                                    </div>
                                </div>
                    ...
                    <form method="GET" id="mobileFilterForm">
                        ...
                        <div class="filter-group">
                            ...
                            <div class="filter-options">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="category[]" value="womensneakers" 
                                           id="mobile_category_womensneakers" <?php echo (in_array('womensneakers', $category)) ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="mobile_category_womensneakers">
                                        Women Sneakers
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="category[]" value="womenrunning" 
                                           id="mobile_category_womenrunning" <?php echo (in_array('womenrunning', $category)) ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="mobile_category_womenrunning">
                                        Women Running
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="category[]" value="womenathletics" 
                                           id="mobile_category_womenathletics" <?php echo (in_array('womenathletics', $category)) ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="mobile_category_womenathletics">
                                        Women Athletics
                                    </label>
                                </div>
                            </div>
